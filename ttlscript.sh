...
rust_native_image="ttl.sh/rust-matrix-native:2h"
tinygo_native_image="ttl.sh/tinygo-matrix-native:2h"
cpp_native_image="ttl.sh/cpp-matrix-native:2h"
cpp_wasm_image="ttl.sh/cpp-matrix-wasm:2h"
rust_wasm_image="ttl.sh/rust-matrix-wasm:2h"
tinygo_wasm_image="ttl.sh/tinygo-matrix-wasm:2h"
